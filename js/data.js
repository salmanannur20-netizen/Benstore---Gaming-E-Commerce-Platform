...
const PRODUCTS = [
  {
    ...
    description:
      "Carve your own clever path to vengeance in an all-new adventure from developer FromSoftware. Explore late 1500s Sengoku Japan, a brutal period of constant life-and-death conflict, as you come face to face with larger-than-life foes in a dark and twisted world.",
    features: [
      "Single Player",
      "Action Combat",
      "Stealth",
  ...
  },
  {
    ...
    platform: ["PC", "PS5", "Xbox"],
    description:
      "Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord in the Lands Between. A vast world where open fields with a variety of situations are seamlessly connected to huge dungeons.",
    features: [
      "Open World",
      "Multiplayer",
      "Boss Fights",
  ...
  },
  {
    ...
    description:
      "As fires fade and the world falls into ruin, journey into a universe filled with more colossal enemies and environments. Prepare yourself once more and Embrace The Darkness. Dark Souls III is the final chapter in the series.",
    features: [
      "Single Player",
      "Multiplayer",
      "Boss Fights",
  ...
  },
  {
    ...
    platform: ["PC", "PS5"],
    description:
      "Black Myth: Wukong is an action RPG rooted in Chinese mythology. The story is based on Journey to the West, one of the Four Great Classical Novels of Chinese literature. You shall set out as the Destined One to venture into the challenges and marvels ahead.",
    features: [
      "Single Player",
      "Action Combat",
      "Boss Fights",
  ...
  },
  {
    ...
    platform: ["PC", "PS5", "Xbox"],
    description:
      "Inspired by the classic Pinocchio tale, Lies of P is a souls-like action RPG set in a dark Belle Époque world. You must fight through the streets of a ruined city, crafting weapons and mastering new abilities.",
    features: [
      "Single Player",
      "Weapon Crafting",
      "Boss Fights",
  ...
  },
  {
    ...
    platform: ["PS4", "PS5"],
    description:
      "Bloodborne is an action RPG in which you hunt for answers in the ancient city of Yharnam, a city known for its medical advances. Now cursed with a strange endemic illness, the city is plagued with beasts and otherworldly creatures.",
    features: [
      "Single Player",
      "Multiplayer",
      "Gothic Horror",
  ...
  },
  {
    ...
    platform: ["PC", "PS5", "Xbox"],
    description:
      "Step into the shadow of a dying world in Elden Ring: Night Reign — where the light has long surrendered, and only the relentless endure. In this unforgiving realm, every step forward is a gamble, every enemy a test.",
    features: [
      "Co-op",
      "Roguelite",
      "Open World",
  ...
  },
  {
    ...
    platform: ["PC", "PS5", "Xbox"],
    description:
      "Step into the relentless world of Crimson Desert — a land torn apart by endless war, where power is claimed through blood, and loyalty is as fragile as the blades that bind it.",
    features: [
      "Open World",
      "Action Combat",
      "Story Driven",
...
const GALLERY_ITEMS = [
  {
    video: "assets/videos/IMG_9059.MOV",
    poster: "assets/images/games/elden-ring.jpg",
    label: "Combat Moments",
  },
  {
    video: "assets/videos/IMG_9060.MOV",
    poster: "assets/images/games/sekiro.jpg",
    label: "Epic Boss Fights",
  },
  {
    video: "assets/videos/IMG_9057.MP4",
    poster: "assets/images/games/Bloodborne-1030x579.jpg",
    label: "Dark Atmosphere",
  },
  {
    video: "assets/videos/IMG_9058.MP4",
    poster: "assets/images/games/DarkSouls3.jpg",
    label: "Ashen Ones",
  },
];
